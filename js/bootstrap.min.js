...
/*! * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=459efb035d862da61faf) * Config saved to config.json and https://gist.github.com/459efb035d862da61faf */
...
(jQuery),+function(t){
    ...
    function e(e){
        return this.each(function(){
            ...
            ,i.DEFAULTS,o.data(),"object"==typeof e&&e),a="string"==typeof e?e:s.slide;
    ...
    var n=function(i){
        ...
        if(s.hasClass("carousel")){
            ...
            ,s.data(),n.data()),r=n.attr("data-slide-to");
...
(jQuery),+function(t){
    ...
    function e(e,o){
        return this.each(function(){
            var n=t(this),s=n.data("bs.modal"),a=t.extend({
            }
...
(jQuery),+function(t){
    ...
    ,i.prototype.init=function(e,i,o){
        ...
        for(var n=this.options.trigger.split(" "),s=n.length;
        s--;
        ){
            var a=n[s];
...
(jQuery),+function(t){
    ...
    i.VERSION="3.3.5",i.DEFAULTS=t.extend({
    }
    ...
    ,t.fn.tooltip.Constructor.prototype),i.prototype.constructor=i,i.prototype.getDefaults=function(){
        return i.DEFAULTS
    }
    ,i.prototype.setContent=function(){
        ...
        if(o||(o=e.attr("href"),o=o&&o.replace(/.*(?=#[^\s]*$)/,"")),!e.parent("li").hasClass("active")){
            ...
            if(n.trigger(s),e.trigger(a),!a.isDefaultPrevented()&&!s.isDefaultPrevented()){
                ...
                this.activate(e.closest("li"),i),this.activate(r,r.parent(),function(){
                    n.trigger({
                        type:"hidden.bs.tab",relatedTarget:e[0]
                    }
                    ),e.trigger({
                        type:"shown.bs.tab",relatedTarget:n[0]
                    }
                    )
                }
                )
...
(jQuery),+function(t){
    ...
    var i=function(e,o){
        ...
        ,i.DEFAULTS,o),this.$target=t(this.options.target).on("scroll.bs.affix.data-api",t.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",t.proxy(this.checkPositionWithEventLoop,this)),this.$element=t(e),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()
    }
    ;
    ...
    ,t(window).on("load",function(){
        t('[data-spy="affix"]').each(function(){
            ...
            ,null!=o.offsetBottom&&(o.offset.bottom=o.offsetBottom),null!=o.offsetTop&&(o.offset.top=o.offsetTop),e.call(i,o)
        }
        )
    }
    )
...
(jQuery),+function(t){
    ...
    function i(e){
        return this.each(function(){
            var i=t(this),n=i.data("bs.collapse"),s=t.extend({
            }
            ,o.DEFAULTS,i.data(),"object"==typeof e&&e);
    ...
    var o=function(e,i){
        ...
        ,o.DEFAULTS,i),this.$trigger=t('[data-toggle="collapse"][href="#'+e.id+'"],[data-toggle="collapse"][data-target="#'+e.id+'"]'),this.transitioning=null,this.options.parent?this.$parent=this.getParent():this.addAriaAndCollapsedClass(this.$element,this.$trigger),this.options.toggle&&this.toggle()
    }
    ;
...
(jQuery),+function(t){
    ...
    function e(i,o){
        ...
        ,e.DEFAULTS,o),this.selector=(this.options.target||"")+" .nav li > a",this.offsets=[],this.targets=[],this.activeTarget=null,this.scrollHeight=0,this.$scrollElement.on("scroll.bs.scrollspy",t.proxy(this.process,this)),this.refresh(),this.process()
    }
    function i(i){
        return this.each(function(){
